...
```{r base_tree, echo = FALSE, fig.width = 12, fig.height = 8}
base.tree
```
...
```{r cac_logCS, echo = FALSE, fig.width = 12, fig.height = 8}
allo.Plots $ CAC.logCS
```

--- &vertical

```{r tree_inter, echo = FALSE, fig.height = 8, fig.width = 12}
Tree.Plots$inter.tree
```

***
```{r tree_slope, echo = FALSE, fig.height = 8, fig.width = 12}
Tree.Plots$slope.tree
```

--- &vertical

```{r MI_vs_slopeW_main, echo = FALSE, fig.width = 12, fig.height = 6}
allo.Plots $ MI.vs.Wslope.main
```

***

```{r MI_vs_slopeW_si, echo = FALSE, fig.width = 12, fig.height = 8}
...
```{r cac_homi, echo = FALSE, fig.width = 10, fig.height = 8}
cac.homi
```
