...
<div class='notes'>
Oral: mastigação;
Nasal: respiração/termorregulação;
Zigomático: sustentação da musculatura associada à elevação da mandíbula;
Órbita/Abóbada: proteção das órbitas oculares e SNC;
Basicrânio: sustentação das demais estruturas e conexões com o resto dos sistemas do organismo.
</div>
...
<div class='notes'>
musculatura induz o crescimento da face

enquanto cresce, cérebro exerce pressão e induz a secreção de fatores de crescimento do neurocrânio a partir de suas membranas envoltórias
...
![](../Figuras/skull_lm.png)

## Distâncias Lineares {.centered}
![](../Figuras/skull_dist.png)
...
herda a separação de tamanho e forma da abordagem baseada em coordenadas
...
\[
\text{MHI} = \frac {{\color{blue} \rho_d} - \rho_f} {\text{ICV}}
\]
...
<img src='../Figuras/sig.png', width = 700px>
...
## Seleção em Homininae {.centered}
![Ackermann \& Cheverud 2004](../Figuras/sel_homininae.png)

<div class='notes'>
na separação entre australopithecini e hominini, a linhagem que dá origem a Homo sofreu 
</div>

## Seleção sobre Forma {.centered}
...
* Testes a respeito da distribuição de diversidades sobre a filogenia:
    + Um nó sozinho corresponde à maior parte da diversidade;
    + Apenas alguns nós correspondem à maior parte da diversidade;
    + Diversidade acumulada na base/topo da filogenia;

* $H_0$: Distribuição de diversidade ao acaso sobre a filogenia;
    + Distribuição nula gerada a partir de permutações sobre a filogenia.
...
Divergência em covariâncias entre linhagens-irmãs apresentam um padrão consistente com interações ontogenéticas/funcionais.
