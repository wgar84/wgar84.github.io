...
```{r ppca_eval, fig.width = 7, fig.height = 7, echo = FALSE, warning = FALSE, message = FALSE}
ppca.Plots $ eval.profile + guides(fill = FALSE)
```

***

```{r var_moran, fig.width = 7, fig.height = 7, echo = FALSE, warning = FALSE, message = FALSE}
